...
dat_ASP$RVISINF <- factor(dat_ASP$RVISINF, 
                    levels = c("N", "Y"), 
                    labels = c("No", "Yes"))
dat_ASP$RVISINF <- factor(dat_ASP$STYPE, 
                    levels = c("PACS", "TACS", "POCS", "LACS", "Other"), 
