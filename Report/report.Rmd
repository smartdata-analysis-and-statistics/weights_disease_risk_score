...
table1(~ SEX + AGE + RACE + WEIGHTBL + ONSYRS + DIAGYRS + EDSSBL + 
       ...
       caption = "Baseline characteristics of the Placebo patients.")
```


# Pooling of placebo arms
To mimic an observational study, we consider the ADVANCE trial as 'control' placebo group and combine the remaining three trials (AFFIRM, DEFINE and CONFIRM) into an 'active' placebo group. The resulting treatment groups have the following case-mix distribution:
...
Density plots for continuous variables are provided below:
